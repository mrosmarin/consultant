...
**Public site (M2) shipped to production; secure portal (M4/M5) underway.** M4 portal shell + dashboard landed (DEV-95). Now closing **DEV-96 — Timesheets (M5)**: `time_entries` table + RLS, add/soft-delete server actions, `/account/timesheets` form+list, dashboard "Hours this week" wired to the live sum. Next: DEV-97 — Invoicing (M5). Live at **https://endlessworlds-web.vercel.app** (Git-integrated, `main` → prod).
