...
**M1 complete; M2 (public site) underway.** DEV-90 builds the design-system refinement + shared marketing layout + Home. Live at **https://endlessworlds-web.vercel.app** (Git-integrated, `main` → prod).
