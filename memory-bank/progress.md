...
- **Brand/IA captured** — `docs/brand-and-ia.md` (DEV-89). **Public site started** — `(marketing)` layout (header/footer), navy/azure theme tokens, Home page (hero/stats/services/work/bio/CTA) + nav stubs; all routes render. (DEV-90, M2.)
